...
{
	public partial class EuroToUsd : ContentPage
	{
       ...
       new ConcurrentDictionary<string, decimal>();
        ...
        private void Number_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            try
            {
                ...
                var result = CurrencyConversionAsync(test2, "EUR", "USD");
                var conversion = ConversionRateAsync(test2, "EUR", "USD");
 
                answer.Text = result.Result.ToString("C2", CultureInfo.CreateSpecificCulture("en-US"));
                var exchange ="Hello, today rate is " +conversion.Result.ToString("C2", CultureInfo.CreateSpecificCulture("en-US")); ;
