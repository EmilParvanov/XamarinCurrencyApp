...
namespace CurrencyConverter
{
	...
	public partial class PoundsToEuro : ContentPage
	{
		public PoundsToEuro ()
		{
        ...
        private async Task<decimal> RunEnchanchgeSync()
        {
            ...
            var result = await CurrencyConversionAsync(test2, "EUR", "USD");
            return result;
        }
       ...
       new ConcurrentDictionary<string, decimal>();
        ...
        private void Number_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            {
                decimal test2 = decimal.Parse(number.Text);
                var result = CurrencyConversionAsync(test2, "GBP", "EUR");
                var conversion = ConversionRateAsync(test2, "GBP", "EUR");
